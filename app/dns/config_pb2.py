...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_NAMESERVER'].fields_by_name['skipFallback']._options = None
  _globals['_NAMESERVER'].fields_by_name['skipFallback']._serialized_options = b'\030\001'
  ...
  _globals['_CONFIG'].fields_by_name['disableCache']._options = None
  _globals['_CONFIG'].fields_by_name['disableCache']._serialized_options = b'\030\001'
  _globals['_CONFIG'].fields_by_name['disableFallback']._options = None
  _globals['_CONFIG'].fields_by_name['disableFallback']._serialized_options = b'\030\001'
  _globals['_CONFIG'].fields_by_name['disableFallbackIfMatch']._options = None
  _globals['_CONFIG'].fields_by_name['disableFallbackIfMatch']._serialized_options = b'\030\001'
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableCache']._options = None
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableCache']._serialized_options = b'\030\001'
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableFallback']._options = None
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableFallback']._serialized_options = b'\030\001'
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableFallbackIfMatch']._options = None
  _globals['_SIMPLIFIEDCONFIG'].fields_by_name['disableFallbackIfMatch']._serialized_options = b'\030\001'
  _globals['_SIMPLIFIEDCONFIG']._options = None
  _globals['_SIMPLIFIEDCONFIG']._serialized_options = b'\202\265\030\016\n\007service\022\003dns'
  _globals['_SIMPLIFIEDNAMESERVER'].fields_by_name['skipFallback']._options = None
  _globals['_SIMPLIFIEDNAMESERVER'].fields_by_name['skipFallback']._serialized_options = b'\030\001'
  _globals['_DOMAINMATCHINGTYPE']._serialized_start=3341
  _globals['_DOMAINMATCHINGTYPE']._serialized_end=3410
  _globals['_QUERYSTRATEGY']._serialized_start=3412
  _globals['_QUERYSTRATEGY']._serialized_end=3465
  _globals['_CACHESTRATEGY']._serialized_start=3467
  _globals['_CACHESTRATEGY']._serialized_end=3519
  _globals['_FALLBACKSTRATEGY']._serialized_start=3521
  _globals['_FALLBACKSTRATEGY']._serialized_end=3590
  _globals['_NAMESERVER']._serialized_start=204
  _globals['_NAMESERVER']._serialized_end=980
  _globals['_NAMESERVER_PRIORITYDOMAIN']._serialized_start=790
  _globals['_NAMESERVER_PRIORITYDOMAIN']._serialized_end=876
  _globals['_NAMESERVER_ORIGINALRULE']._serialized_start=878
  _globals['_NAMESERVER_ORIGINALRULE']._serialized_end=920
  _globals['_HOSTMAPPING']._serialized_start=982
  _globals['_HOSTMAPPING']._serialized_end=1101
  _globals['_CONFIG']._serialized_start=1104
  _globals['_CONFIG']._serialized_end=1817
  _globals['_CONFIG_HOSTSENTRY']._serialized_start=1732
  _globals['_CONFIG_HOSTSENTRY']._serialized_end=1811
  _globals['_SIMPLIFIEDCONFIG']._serialized_start=1820
  _globals['_SIMPLIFIEDCONFIG']._serialized_end=2398
  _globals['_SIMPLIFIEDHOSTMAPPING']._serialized_start=2401
  _globals['_SIMPLIFIEDHOSTMAPPING']._serialized_end=2530
  _globals['_SIMPLIFIEDNAMESERVER']._serialized_start=2533
  _globals['_SIMPLIFIEDNAMESERVER']._serialized_end=3339
  _globals['_SIMPLIFIEDNAMESERVER_PRIORITYDOMAIN']._serialized_start=790
  _globals['_SIMPLIFIEDNAMESERVER_PRIORITYDOMAIN']._serialized_end=876
  _globals['_SIMPLIFIEDNAMESERVER_ORIGINALRULE']._serialized_start=878
  _globals['_SIMPLIFIEDNAMESERVER_ORIGINALRULE']._serialized_end=920
